...
public class ConversionServiceLocator extends org.apache.axis.client.Service implements currency.conversion.ConversionService {
    ...
    private java.lang.String Conversion_address = "http://localhost:8080/currency/Conversion.jws";
    ...
    public currency.conversion.Conversion_PortType getConversion(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            currency.conversion.ConversionSoapBindingStub _stub = new currency.conversion.ConversionSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (currency.conversion.Conversion_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                currency.conversion.ConversionSoapBindingStub _stub = new currency.conversion.ConversionSoapBindingStub(new java.net.URL(Conversion_address), this);
                _stub.setPortName(getConversionWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/currency/Conversion.jws", "ConversionService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/currency/Conversion.jws", "Conversion"));
        }
